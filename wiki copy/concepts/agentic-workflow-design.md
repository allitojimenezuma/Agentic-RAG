---
slug: concepts/agentic-workflow-design
type: concept
...
- Subagent-driven development: Decomposing a task into parallel specialized sub-agents.
- Loop engineering: Iterative improvement loops for self-correction.
- Guardrails: Safety constraints to bound agent actions.
